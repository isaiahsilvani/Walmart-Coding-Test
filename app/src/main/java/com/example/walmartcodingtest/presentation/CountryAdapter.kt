...
class CountryAdapter : RecyclerView.Adapter<CountryAdapter.CountryViewHolder>() {
    ...
    inner class CountryViewHolder(countryView: View) :RecyclerView.ViewHolder(countryView) {
        ...
        init {
            name = countryView.findViewById(R.id.tvCountryName)
            region = countryView.findViewById(R.id.tvRegion)
            capital = countryView.findViewById(R.id.tvCapital)
            code = countryView.findViewById(R.id.tvCode)
        }
    }
